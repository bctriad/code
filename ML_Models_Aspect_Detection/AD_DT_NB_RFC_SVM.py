#This code is used to Model Decision Tree, Random Forest, Naive Bayes and SVM for Aspect Detection task.
#The code utilizes the dataset All_Aspect_Dataset.json to train Decision Tree, Random Forest, Naive Bayes and SVM. 
...
def train_model(test_perc):
    ...
    #Read All_Aspect_Dataset.json dataset and store it in a list 
    with open('All_Aspect_Dataset.json' , 'r') as f:
