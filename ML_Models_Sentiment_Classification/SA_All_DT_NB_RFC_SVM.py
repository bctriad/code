#This code is used to Model Decision Tree, Random Forest, Naive Bayes and SVM for Sentiment Classification task.
#The code utilizes the dataset All_Sentiments_Dataset.json to train Decision Tree, Random Forest, Naive Bayes and SVM. 
...
def train_model(test_perc):
    ...
    #List used to dump the data from All_Sentiments_Dataset.json
    data = list()
    
    #Read All_Sentiments_Dataset.json dataset and store it in a list
    with open('All_Sentiments_Dataset.json' , 'r') as f:
